...
function Editimg() {
    ...
    const { _id,prevImage } = location.state ;
    const [image,setImage]=useState('')
    const navigate=useNavigate()
    const [imgPrev,setImgpreview]=useState(prevImage)
    const handleImage=(e)=>{
  ...
  console.log(image)
    ...
    const handleSubmit=async()=>{
       try {
         ...
         const res=await axios.patch('http://localhost:4000/api/v1/blog/editImage',formData,{
