    ...
    <div className="max-w-xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
      <div className="p-4">
        <div className="flex items-center">
          <img className="h-12 w-12 rounded-full" src={post.owner.avatar} alt="Profile" />
          <div className="ml-3">
            <div className="flex items-center">
              <span className="text-lg font-bold">{post.owner.fullname}</span>
          ...
          {user._id===post.owner._id && (<div className='flex justify-end mr-auto items-end'><DropdownMenu>
        ...
        <h2 className='font-bold mb-2 text-3xl'>{post.title}</h2>
